...
namespace SeasonalBastion
{
    ...
    public sealed class BalanceConfig
    {
        ...
        [Serializable] public sealed class Movement { public float defaultBaseMoveSpeed = 1f; public float defaultRoadSpeedMultiplier = 1.3f; }
        [Serializable] public sealed class Carry
        {
        ...
        [Serializable] public sealed class Build { public float workChunkSec = 6f; public int fallbackBuildChunksL1 = 2; }
        [Serializable] public sealed class Repair { public float workChunkSec = 4f; public float healPctPerChunk = 0.15f; public float costFactorOfBuildCost = 0.30f; }
        [Serializable] public sealed class BuilderWorkplace
        {
        ...
        [Serializable] public sealed class WarehouseWorkplace { public string[] warehouseDefIds; }
        [Serializable] public sealed class Armory { public Level3Int resupplyTripAmmo = new() { L1 = 20, L2 = 30, L3 = 40 }; }
        [Serializable] public sealed class Crafting { public string ammoRecipeId = "ForgeAmmo"; }
        [Serializable] public sealed class AmmoSupply { public int forgeTargetCrafts = 5; }
        [Serializable] public sealed class AmmoMonitor
        {
